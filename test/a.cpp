...
#include <FastLED.h>
#include <LittleFS.h>                    // Please read the instructions on http://arduino.esp8266.com/Arduino/versions/2.3.0/doc/filesystem.html#uploading-files-to-file-system

#define countof(a) (sizeof(a) / sizeof(a[0]))
#define NUM_LEDS 86                           // Total of 86 LED's     
#define DATA_PIN 12                           // Change this if you are using another type of ESP board than a WeMos D1 Mini
